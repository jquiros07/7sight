...
class TrimVideoJob implements ShouldQueue
{
    ...
    {
        Log::info('TrimVideoJob started', ['video_tool_job_id' => $this->videoToolJob->id]);
        ...
        try {
            ...
            $processor->trim(
                ...
                (float) $this->videoToolJob->params['start_seconds'],
                (float) $this->videoToolJob->params['end_seconds'] - (float) $this->videoToolJob->params['start_seconds'],
            );
            ...
            Log::info('TrimVideoJob finished', ['video_tool_job_id' => $this->videoToolJob->id]);
        } catch (Throwable $e) {
